...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer5 = nn.Conv2d(2048, out_channels=256, kernel_size=1) #added to reduce the chnnel length so as to match with the alexnet 
        # self.avgpool = nn.AvgPool2d(7, stride=1)
        self.avgpool = nn.AdaptiveAvgPool2d((6, 6)) #added to reduce HW dimension
